...
public:
    ...
    enum Pattern
    {
        NOT_EXISTING, CHESSBOARD1, CIRCLES_GRID, ASYMMETRIC_CIRCLES_GRID
    };
    enum InputType
    {
    ...
    void validate()
    {
        ...
        if (!patternToUse.compare("CHESSBOARD"))
            calibrationPattern = CHESSBOARD1;
...
int main(int argc, char* argv[])
{
    ...
    for (;;)
    {
        ...
        if (found)                // If done with success,
        {
            ...
            if (s.calibrationPattern == Settings::CHESSBOARD1)
            {
                Mat viewGray;
        ...
        Settings::Pattern patternType /*= Settings::CHESSBOARD*/)
{
    ...
    case Settings::CIRCLES_GRID:
        for (int i = 0; i < boardSize.height; ++i)
            ...
            {
                std::cout << j * squareSize << " " << i * squareSize
                        << std::endl;
